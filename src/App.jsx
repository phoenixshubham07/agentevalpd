...
export default function App() {
  ...
  return (
    <div className="w-full h-screen bg-[#050505] text-slate-200 font-sans selection:bg-purple-500 selection:text-white flex flex-col overflow-hidden">
      ...
      <div className="absolute top-8 right-8 z-50 px-4 py-2 bg-black/40 border border-slate-800/50 rounded-full backdrop-blur-md flex items-center gap-2">
